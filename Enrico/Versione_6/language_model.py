...
class LanguageModel:  # B-ver.
    ...
    async def write_answer(self, prompt: str, n4j_results: str) -> str:
        ...
        :param prompt: the LLM prompt; it should contain the question and the Neo4j results
        :param n4j_results: the Neo4j results, in Cypher format
        :return: the natural language answer with the results explaination
        """
